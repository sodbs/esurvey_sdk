package com.esurvey.esurvey_sdk_demo.utils;
...
public class HttpClientUtils {
    ...
    public static void post(final String requestUrl, final String params, String appToken, final OnRequestCallBack callBack) {
        postRequest(requestUrl, params, appToken, callBack);
    }
    ...
    private static void postRequest(String requestUrl, String params,  String appToken, OnRequestCallBack callBack) {
        boolean isSuccess = false;
        String message;
        InputStream inputStream = null;
        ByteArrayOutputStream baos = null;
